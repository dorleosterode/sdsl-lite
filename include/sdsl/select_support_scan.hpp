...
{
    private:
        static_assert(t_b == 1u or t_b == 0u or t_b == 10u or t_b == 11u or t_b == SDSL_WT_DNA_TYPE_A or t_b == SDSL_WT_DNA_TYPE_C or t_b == SDSL_WT_DNA_TYPE_G or t_b == SDSL_WT_DNA_TYPE_T, "select_support_scan: bit pattern must be `0`,`1`,`10` or `01`");
